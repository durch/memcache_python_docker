...
client.set('test_int', "1")
assert (client.get('test_int') == "1".encode())
client.incr('test_int', 1)
assert (client.get('test_int') == "2".encode())
client.decr('test_int', 2)
assert (client.get('test_int') == "0".encode())

client.replace('test_int', 1)
assert (client.get('test_int') == 1)
client.incr('test_int', 1)
assert (client.get('test_int') == 2)
client.decr('test_int', 2)
assert (client.get('test_int') == 0)
